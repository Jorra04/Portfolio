    ...
    return (
        <div className=" flex h-full w-full justify-center items-center">
            <div className="basis-1/4">
                <h1 className="lg:text-8xl md:text-7xl sm:text-5xl xsm:text-4xl xxsm:text-2xl">Hello! I am Jorra Singh.</h1>
            </div>
            <div className="basis-3/4 flex justify-center items-center h-5/6 overflow-scroll">
                <div className='w-1/2 h-full'>
                    <p className="lg:text-lg md:text-base xxsm:text-sm">{paragraph}</p>
                </div>
            </div>
        </div>
    )
